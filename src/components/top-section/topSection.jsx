...
import {TopPerformerList,TopShowsList} from "../../redux/top-performers/action.js"
		...
		<div class="container">			
			...
			<div class="col-lg-12 wow slideInLeft" style={{animationDuration: "3s"}}> 
					<div class="col-lg-4 pad10 wow slideUp" style={{animationDuration: "2s"}}> 
						<h1> Artists</h1>
						{this.state.performer_list && this.state.performer_list.map((perfoermer,key)=>(
							<div class="event_box"> 
							<div class="date"> <h3>{key+1}</h3></div>
							<div class="Info"> <h3>{perfoermer.text.name} </h3>   
							</div> 
						</div>
						))}	
					...
					<div class="col-lg-4 pad10 wow slideUp" style={{animationDuration: "2s"}}> 
						...
						<div class="event_box"> 
							...
							<div class="Info"> <h3>NFL Football </h3>   
							</div> 
						</div>
						<div class="event_box"> 
							<div class="date"> <h3>2</h3></div>
							<div class="Info"> <h3>NBA Basketball </h3>   
							</div> 
						</div>
						<div class="event_box"> 
							<div class="date"> <h3>3</h3></div>
							<div class="Info"> <h3>NHL Hockey </h3>   
							</div> 
						</div>
						<div class="event_box"> 
							<div class="date"> <h3>4</h3></div>
							<div class="Info"> <h3>MLB Baseball </h3>   
							</div> 
						</div>
						<div class="event_box"> 
							<div class="date"> <h3>5</h3></div>
							<div class="Info"> <h3>NCAA Football </h3>   
							</div> 
						</div>
					</div>
					...
					<div class="col-lg-4 pad10 wow slideUp" style={{animationDuration: "2s"}}> 
						...
						{this.state.top_shows && this.state.top_shows.map((shows,key)=>(
							<div class="event_box"> 
							<div class="date"> <h3>{key+1}</h3></div>
							<div class="Info"> <h3>{shows.text.name} </h3>   
							</div> 
						</div>
						))}	
					</div>
